...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        modemmanager kmod-usb-acm kmod-usb-net-qmi-wwan kmod-usb-serial-option kmod-usb-serial-wwan libmbim libqmi libqrtr-glib mbim-utils qmi-utils sms-tool umbim uqmi \
        \
