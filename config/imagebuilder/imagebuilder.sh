...
download_imagebuilder() {
    ...
    tar -xvJf *-imagebuilder-* && sync && rm -f *-imagebuilder-*.tar.xz
...
rebuild_firmware() {
    ...
    my_packages="\
        -dnsmasq dnsmasq-full cgi-io libiwinfo libiwinfo-data libiwinfo-lua liblua liblucihttp liblucihttp-lua \
        ...
        -libustream-openssl20201210 libc php8 php8-cgi php8-mod-session php8-mod-ctype php8-mod-fileinfo php8-mod-zip php8-mod-iconv php8-mod-mbstring \
